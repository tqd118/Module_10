...
export default function Register() {
    ...
    const passwordStrength = formik.values.password.length >= 8 ? t("auth.strongPassword") : "";

    return (
        <div className={s.page}>
            <div>
                <h2 className={s.heading}>{t("auth.signUpHeading")}</h2>
                <p className={s.subHeading}>{t("auth.signUpSubHeading")}</p>
            </div>
